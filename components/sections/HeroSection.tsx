...
export function HeroSection({ user }: HeroSectionProps) {
  ...
  return (
    ...
    >
      ...
      {/* Static Background Elements - removed heavy animations */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/4 -left-1/4 w-1/2 h-1/2 rounded-full bg-[var(--accent-primary)]/10 blur-3xl" />
        <div className="absolute -bottom-1/4 -right-1/4 w-1/2 h-1/2 rounded-full bg-[var(--accent-secondary)]/10 blur-3xl" />
      </div>
